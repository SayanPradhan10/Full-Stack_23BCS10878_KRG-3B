...
<head>
    ...
    <title>PDF Generation Error - Resume Builder</title>
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-body text-center p-5">
                        ...
                        <h1 class="h2 mb-3 text-dark">PDF Generation Failed</h1>
                        <p class="lead text-muted mb-4">
                            <c:out value="${errorMessage}" default="We encountered an issue generating your PDF. Please try again." />
                        </p>
                        <div class="alert alert-warning" role="alert">
                            <i class="fas fa-exclamation-triangle me-2"></i>
                            This is usually a temporary issue. Please try generating your resume again.
                        </div>
                        <div class="mt-4">
